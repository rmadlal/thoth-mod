...
public class ProceduralRoom : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		if (ProceduralRoom.playerDied && !ProceduralRoom.respawnInLava && !Globals.checkpointCheat)
		{
			...
			Room.anotherChance = Globals.lavaAlwaysOn;
		}
	...
	private void Start()
	{
		...
		if (!Globals.cheatRepeatLevel || ProceduralRoom.roomCounter <= 0)
		{
			ProceduralRoom.roomCounter++;
		}
		if (ProceduralRoom.roomCounterTarget == 12 && ProceduralRoom.roomCounter == 12 && !Globals.cheatRepeatLevel)
		{
