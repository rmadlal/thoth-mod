...
public class RoomMusic : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            if (!this.musicChanged && Globals.currentRoom.IsRoomCompleted() && ((Globals.currentRoom.roomID == 4 && !NewMenu.cheatRepeatLevel) || (Globals.currentRoom.roomID < 0 && ProceduralRoom.roomCounter == ProceduralRoom.roomCounterTarget)))
            // from here unchanged
            {
